var Z = Object.defineProperty, R = (e, t) => {
  let n = {};
  for (var r in e)
    Z(n, r, {
      get: e[r],
...
function S(e, t) {
  ...
  if (r.startsWith("t:")) {
    ...
    return s.unshift("t"), s[0] += ":" + c.join(":"), H(s, a, t);
  }
  if (r.startsWith("'") && r.endsWith("'")) {
    const [a, ...c] = r.slice(1, -1).split(":");
    return s.unshift("t"), s[0] += ":" + c.join(":"), H(s, a, t);
  }
  const o = ((r || "").replace(/{([^{}]+)}/g, (a, c) => S(c.trim(), t)) || "").split(/\.|\[|\]/).filter((a) => a !== "");
  let i = t || self;
  if (Ae(o[0] || "", t)) {
...
function H(e, t, n) {
  return e.reduce((r, s) => {
    const [o, ...i] = _e(s, ":"), a = S(o, n) || te[o || ""];
    if (typeof a == "function") {
      const c = i.map((l) => l.startsWith("'") && l.endsWith("'") ? l.slice(1, -1) : l.startsWith("@") ? S(l.slice(1), n) : l);
...
function G(e, t) {
  ...
  for (; n < e.length; ) if (e.startsWith("@if(", n)) {
    ...
    const l = e.slice(a, c), u = re(ie(i), t);
    u === "__UNDEFINED__" ? r += `@if(${i})${l}@endif` : u && (r += G(l, t)), n = c + 6;
  } else
    r += e[n], n++;
  return r;
}
    ...
    if (Object.assign(s, i), o && (s.className = o), r && "slottedNodes" in r) {
      ...
      for (const [c, l] of Object.entries(a)) {
        ...
        if (u) {
          ...
          for (const p of l) p instanceof Node && f.insertBefore(p, u);
          u.remove();
        }
      }
    }
...
function J(e, t) {
  ...
  for (t.bindings || (t.bindings = []); r; ) {
    ...
    Array.from(s.attributes).forEach((o) => {
      ...
      if (i === "on-publish") {
        const [c, l, u, ...f] = a.split(":"), p = l === "local" ? t.instanceId : void 0, h = L.subscribe(c, (m) => {
      ...
      if (i === "on-state") !t.on || typeof t.on != "function" ? (console.warn("on-state requiere un useState conectado al contexto"), s.removeAttribute(i)) : (a.split(";").map((c) => c.trim()).filter(Boolean).forEach((c) => {
        const [l = "", ...u] = c.split(":").map((b) => b.trim()), f = u.join(":"), [p, h] = l.includes(".") ? l.split(".") : [l, null], [m, ...E] = f.split("|").map((b) => b.trim()), y = (m || "").split(".")[0];
        if (!y) return;
        const d = Y({
          element: s,
          type: p,
        ...
        const [l = "", ...u] = c.split(":").map((y) => y.trim()), f = u.join(":"), p = I(u, t), [h, m] = l.includes(".") ? l.split(".") : [l, null], E = {
          element: s,
          type: h,
          prop: m,
          path: f,
...
async function Q(e, t) {
  ...
  for (const r of Array.from(n)) {
    ...
    i.init?.({ parent: r });
    const c = i.render();
    if (c && (X.bind(i, c), c.id || c.setAttribute("id", r.id), c.setAttribute(s, ""), a)) {
...
function Y(e) {
  const { type: t, prop: n, params: r } = e, s = (i, a, c) => {
    if (!a) return;
    const l = i.__instance;
    if (l) {
      l.setProp?.(a, c);
      return;
    }
    ...
    fn: (i, a) => {
      typeof a == "function" ? a(i, r?.slice(1)) : console.warn(`La función '${e.path}' no se encontró en el contexto.`);
    },
    text: (i, a) => i.innerText = a ?? "",
    html: (i, a) => i.innerHTML = a ?? "",
    prop: (i, a) => s(i, n, a),
    value: (i, a) => s(i, "value", a),
    checked: (i, a) => i.checked = !!a,
    attr: (i, a) => a == null ? i.removeAttribute(n) : i.setAttribute(n, String(a)),
    class: (i, a) => i.className = a ?? "",
    toggle: (i, a) => i.classList.toggle(n, !!a),
    style: (i, a) => i.style[n] = a,
    show: (i, a) => i.style.display = a ? "" : "none",
    hide: (i, a) => i.style.display = a ? "none" : "",
    disabled: (i, a) => i.disabled = !!a
  };
  return o[t] || o.text || (() => {
  });
}
...
function F(e, t) {
  ...
  if (e.type === "fn" && e.depExpressions) {
    const i = e.depExpressions.map((a) => S(a, t));
...
var X = class V {
  ...
  setupOutputs(t) {
    ...
    Array.from(n.attributes).forEach((o) => {
      ...
      const i = o.name.slice(1, -1).replace(/-([a-z])/g, (f, p) => p.toUpperCase()), a = o.value.trim(), c = a.match(/^([\w\\.]+)\[(.+)\]$/);
      let l;
      if (c) {
        const [, f, p] = c, h = S(f, s);
        l = {
...
function he(e) {
  ...
  const s = new Proxy(e, {
    ...
    set(l, u, f) {
      const p = u;
      return l[p] === f || (l[p] = f, r || t[p]?.forEach((h) => h(f)), n.forEach((h) => h(f))), !0;
    }
  }), o = (l, u) => {
    s[l] = u;
  }, i = (l, u) => (t[l] || (t[l] = []), t[l].push(u), () => {
    t[l] && (t[l] = t[l].filter((f) => f !== u), t[l].length === 0 && delete t[l]);
  });
  return {
    store: s,
    put: o,
...
var gt = class {
  ...
  updatePositionTooltip() {
    const e = this.triggerElement.getBoundingClientRect(), t = this.portalElement.offsetHeight, n = this.portalElement.offsetWidth, r = window.innerHeight, s = window.innerWidth, o = this.options.offset ?? 6, i = this.options.placement ?? "top", a = {
      ...
      left: "right",
      right: "left"
    }, l = i.split("-")[0], u = a[l] >= t + o ? l : c[l], f = e.left + e.width / 2 - n / 2, p = e.top + e.height / 2 - t / 2;
    let h, m;
    switch (u) {
      case "top":
        h = e.top - t - o, m = f;
...
function ot() {
  ...
  return {
    ...
    async invoke() {
      ...
      const { url: l, payload: u, method: f } = st((e || "") + n, s, o), p = {
...
var ut = class {
  generateReport(e, t, n) {
    ...
    const o = () => {
      ...
      d && g.splice(0, d), g.reverse().forEach((w, v) => {
        ...
        if (A.footerValueProvider) {
          ...
          if (N) {
            ...
            const { records: k, recordCount: $, key: Ee, summary: we } = N, Ce = {
      ...
      m.forEach((d) => {
        if (d.valueProvider) {
          const { id: g } = d, { recordCount: w, dataSet: v, isLastRow: b, isLastRowInGroup: C, percent: O, previous: _, data: A } = r, P = y.reduce((N, k) => {
            const $ = k.name;
            return N[k.name] = r[$].all, N;
          }, {}), T = {
    ...
    e.iteratefn && s.forEach(e.iteratefn), e.orderBy && (s = at(s, e.orderBy)), r.dataSet = s, r.reportDefinition = e, y.forEach((d) => {
      ...
      const w = d.name;
      r[w] = { all: {} };
    }), e.onStartfn && e.onStartfn(r), l(), s.length > 0 && o(), s.forEach((d) => {
...
}, ht = new pt(), yt = Oe, bt = Me, vt = Se, Et = We, wt = ke, Ct = {
  ...Be,
  storage: nt
}, St = {
  RQ: it,
