// DashboardComponent – panel de control que muestra contadores y laboratorio de reactividad.
(function () {
  ...
  class DashboardComponent extends BaseComponent {
    ...
    ternary(val, yes, no) { return val ? yes : no; }
    display(val) { return val ? 'block' : 'none'; }
